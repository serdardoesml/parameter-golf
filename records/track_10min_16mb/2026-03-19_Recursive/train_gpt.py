...
class RMSNorm(nn.Module):
    def __init__(self, dim: int, eps: float | None = None, bias: bool = False):
        super().__init__()
        self.eps = eps
    ...
    def forward(self, x: Tensor) -> Tensor:
        x = F.rms_norm(x, (x.size(-1),), weight=self.weight.to(dtype=x.dtype), eps=self.eps)
...
def main() -> None:
    ...
    # - matrix params in the transformer body use MATRIX_LR via Muon
